importScripts('./fastnoise-lite.js?v=034','./map-core.js?v=034','./region-v20.js?v=034');
importScripts('./map-wasm.js?v=034');
...
self.onmessage=async event=>{
  ...
  try{
    ...
    self.postMessage({type:'complete',requestId,width:fullWidth,height:fullHeight,quartReady:data.layer==='kaolin',riverRasterReady:data.layer==='rivers',usedWasm:!!wasm});
